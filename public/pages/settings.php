...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // database - debug
    if (isset($_POST['database']['debug'])) {
        $form['values']['database']['debug'] = true;
    } else {
        $form['values']['database']['debug'] = false;
    }
                ...
                <form class="form-horizontal" method="post">
                    ...
                    <div class="form-group<?= (!empty($form['errors']['webui']['user']) ? ' has-error has-feedback' : '') ?>">
                        ...
                        <div class="col-xs-8">
                            ...
                            <?php if (!empty($form['errors']['webui']['user'])): ?><span class="glyphicon glyphicon-warning-sign form-control-feedback"></span><?php endif ?>
                            <?php if (!empty($form['errors']['webui']['user'])): ?><span class="help-block"><?= $form['errors']['webui']['user'] ?></span><?php endif ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group<?= (!empty($form['errors']['name']) ? ' has-error has-feedback' : '') ?>">
                        ...
                        <div class="col-xs-8">
                            ...
                            <?php if (!empty($form['errors']['webui']['name'])): ?><span class="glyphicon glyphicon-warning-sign form-control-feedback"></span><?php endif ?>
                            <?php if (!empty($form['errors']['webui']['name'])): ?><span class="help-block"><?= $form['errors']['webui']['pass'] ?></span><?php endif ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group<?= (!empty($form['errors']['plinker']['peer']) ? ' has-error has-feedback' : '') ?>">
                        ...
                        <div class="col-xs-8">
                            <input type="text" class="form-control" id="plinker-peer" name="plinker[peer]" value="<?= (!empty($form['values']['plinker']['peer']) ? htmlentities($form['values']['plinker']['peer']) : '') ?>" placeholder="Peer address URL...">
                            <?php if (!empty($form['errors']['plinker']['peer'])): ?><span class="glyphicon glyphicon-warning-sign form-control-feedback"></span><?php endif ?>
                            <?php if (!empty($form['errors']['plinker']['peer'])): ?><span class="help-block"><?= $form['errors']['plinker']['peer'] ?></span><?php endif ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group<?= (!empty($form['errors']['plinker']['tracker']) ? ' has-error has-feedback' : '') ?>">
                        ...
                        <div class="col-xs-8">
                            ...
                            <?php if (!empty($form['errors']['plinker']['tracker'])): ?><span class="glyphicon glyphicon-warning-sign form-control-feedback"></span><?php endif ?>
                            <?php if (!empty($form['errors']['plinker']['tracker'])): ?><span class="help-block"><?= $form['errors']['plinker']['tracker'] ?></span><?php endif ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group<?= (!empty($form['errors']['plinker']['public_key']) ? ' has-error has-feedback' : '') ?>">
                        ...
                        <div class="col-xs-8">
                            ...
                            <?php if (!empty($form['errors']['plinker']['public_key'])): ?><span class="glyphicon glyphicon-warning-sign form-control-feedback"></span><?php endif ?>
                            <?php if (!empty($form['errors']['plinker']['public_key'])): ?><span class="help-block"><?= $form['errors']['plinker']['public_key'] ?></span><?php endif ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group<?= (!empty($form['errors']['plinker']['private_key']) ? ' has-error has-feedback' : '') ?>">
                        ...
                        <div class="col-xs-8">
                            ...
                            <?php if (!empty($form['errors']['plinker']['private_key'])): ?><span class="glyphicon glyphicon-warning-sign form-control-feedback"></span><?php endif ?>
                            <?php if (!empty($form['errors']['plinker']['private_key'])): ?><span class="help-block"><?= $form['errors']['plinker']['private_key'] ?></span><?php endif ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group<?= (!empty($form['errors']['plinker']['encrypted']) ? ' has-error' : '') ?>">
                        ...
                        <div class="col-xs-8">
                            <div class="checkbox">
                                <label><input type="checkbox" name="plinker[encrypted]" value="1"<?= (!empty($form['values']['plinker']['encrypted']) ? ' checked' : '') ?>> Enable</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group<?= (!empty($form['errors']['plinker']['enabled']) ? ' has-error' : '') ?>">
                        ...
                        <div class="col-xs-8">
                            <div class="checkbox">
                                <label><input type="checkbox" name="plinker[enabled]" value="1"<?= (!empty($form['values']['plinker']['enabled']) ? ' checked' : '') ?>> Enable</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group<?= (!empty($form['errors']['sleep_time']) ? ' has-error has-feedback' : '') ?>">
                        ...
                        <div class="col-xs-8">
                            ...
                            <?php if (!empty($form['errors']['sleep_time'])): ?><span class="glyphicon glyphicon-warning-sign form-control-feedback"></span><?php endif ?>
                            <?php if (!empty($form['errors']['sleep_time'])): ?><span class="help-block"><?= $form['errors']['sleep_time'] ?></span><?php endif ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group<?= (!empty($form['errors']['database']['dsn']) ? ' has-error has-feedback' : '') ?>">
                        ...
                        <div class="col-xs-8">
                            ...
                            <?php if (!empty($form['errors']['database']['dsn'])): ?><span class="glyphicon glyphicon-warning-sign form-control-feedback"></span><?php endif ?>
                            <?php if (!empty($form['errors']['database']['dsn'])): ?><span class="help-block"><?= $form['errors']['database']['dsn'] ?></span><?php endif ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group<?= (!empty($form['errors']['database']['username']) ? ' has-error has-feedback' : '') ?>">
                        ...
                        <div class="col-xs-8">
                            ...
                            <?php if (!empty($form['errors']['database']['username'])): ?><span class="glyphicon glyphicon-warning-sign form-control-feedback"></span><?php endif ?>
                            <?php if (!empty($form['errors']['database']['username'])): ?><span class="help-block"><?= $form['errors']['database']['username'] ?></span><?php endif ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group<?= (!empty($form['errors']['database']['password']) ? ' has-error has-feedback' : '') ?>">
                        ...
                        <div class="col-xs-8">
                            ...
                            <?php if (!empty($form['errors']['database']['password'])): ?><span class="glyphicon glyphicon-warning-sign form-control-feedback"></span><?php endif ?>
                            <?php if (!empty($form['errors']['database']['password'])): ?><span class="help-block"><?= $form['errors']['database']['password'] ?></span><?php endif ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group<?= (!empty($form['errors']['database']['freeze']) ? ' has-error' : '') ?>">
                        ...
                        <div class="col-xs-8">
                            <div class="checkbox">
                                <label><input type="checkbox" name="database[freeze]" value="1"<?= (!empty($form['values']['database']['freeze']) ? ' checked' : '') ?>> Enable</label>
                            </div>
                        </div>
                    </div>
