...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $form = [
        ...
        'values' => [
            ...
            'peer'        => (isset($_POST['peer'])        ? trim($_POST['peer'])        : null),
            'public_key'  => (isset($_POST['public_key'])  ? trim($_POST['public_key'])  : null),
            'private_key' => (isset($_POST['private_key']) ? trim($_POST['private_key']) : null),
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-info-circle fa-fw"></i> New Node</h3>
            </div>
